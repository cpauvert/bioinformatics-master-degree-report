...
Only one or few marker genes are sequenced in this approach. The preferred marker for prokaryotes is the ribosomal small sub-unit DNA --termed 16S rDNA-- and the _internal transcribed spacer_ --ITS-- for eukaryotes.
