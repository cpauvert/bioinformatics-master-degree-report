...
Moreover, strains in cheese ecosystems can demonstrate specific metabolic pathways and organoleptic compounds synthesis. Their characterisation will provide leverage for food industry improvements and sustainable quality. 
...
Innovative strategies needs to be applied --or developed-- in order to circumvent this information loss and achieve ecosystem information retrieval using metagenomics --e.g., micro-organism identification.
...
```{r methods, engine="tikz",engine.opts=list(template="template-tikz2pdf.tex"),echo=FALSE, fig.pos="h",fig.align="center",fig.cap="Comparison of post-sequencing strategies."}
...
However, metagenomics data analysis comes with challenges.
Specifically interested in cheese ecosystems in our lab.
<!-- JOBIM abstract inspiration ? -->

I have focused my research on a metagenomics analysis tool --GeDI-- during my bioinformatics apprenticeship.
This two-year work can be crystallised into four axes --tackled or soon-to-be.
I have explored several _improvements_ both in terms of scientific methods and computational features.
As similar tools were published, I started working on a _comparison_ to our tool.
I then worked on GeDI _integration_ with databases and others tools.
