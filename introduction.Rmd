...
The second project is funded by industrials partners from 2015 to 2018. It is divided into two parts: (1) provide a convenient metagenomics analysis tool and (2) characterize dairy strains genomics and functional features.
...
These Food-Microbiome projects gather dairy products experts - mainly microbiologists - from 3 INRA centers: Aurillac (F-15), Grignon (F-78) and Jouy-en-Josas (F-78).
Industrial partners are bring together by the CNIEL -_The French Dairy Interbranch Organization_ - and belongs to these two projects.
...
**Applied Mathematics and Computer Science, from Genomes to the Environment** MaIAGE research unit harbors several collaborators.
