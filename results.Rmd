...
ggplot(data = df, aes(x = Sample, y=Coverage, color=CoverageType, linetype=CoverageType))+ geom_boxplot(position = "dodge") +scale_color_manual(values=c("#2aa2e0", "#ed1a5c"),labels=c("Total","Mismatches"))  + theme_bw() +theme(legend.position="bottom") +labs(title="Fraction of genome covered by\n total and mismatches reads \n in cheese samples")
```
