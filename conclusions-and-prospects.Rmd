...
Previous approaches were only able to detect when whether the exact strain was present both in the ecosystem and as a reference genome onto which reads are mapped.
