...
Table: _Streptococcus_ dataset composition and distance to the reference strain (_Streptococcus salivarius_ JIM8777). Proximity classes are based on ANI _Average Nucleotide Identity_ computed with Gegenees [@agren_gegenees:_2012].{#strep}
