...
\matrix [matrix of nodes,row sep=1em,nodes={align=center,text width=4em},label={[font=\footnotesize]above:Legend},font=\footnotesize] (leg) at (m-2-1|-m-5-3) {%
|[data,text width=2em]| Data\\
|[soft,,text width=4em,pin={below:Filetype}]| Software\\
};
\node[draw,fit={(leg)}] {};
\end{tikzpicture}
